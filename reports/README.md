...
- `forward_test_trades.csv`: closed trades from the local MT5 forward-test export, including open/close time, entry, exit, PnL, and planned SL/TP only when matched to a saved source signal.
