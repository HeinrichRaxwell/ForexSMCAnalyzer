...
def main():
    ...
    # Find index 488 (2026-06-04 23:30:00)
    df['time'] = pd.to_datetime(df['time'])
    target_time = pd.to_datetime("2026-06-04 23:30:00")
    ...
    # Check if there were execution issues (e.g. price too far)
    tick = mt5.symbol_info_tick(symbol)
    if tick is not None:
        # At index 488 (2026-06-04 23:30:00), the close price was:
        ...
        # limit distance is 30 USD for M30
        print(f"Execution Limit: 30.00 USD")
        if dist_a > 30.0:
            print("  Option A entry is too far from market price!")
        if dist_b > 30.0:
            print("  Option B entry is too far from market price!")
